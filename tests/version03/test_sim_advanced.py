...
def test_repeat_roller():
    ...
    """
    diffs = diff(play, path="tests/version03/repeat_roller.sim.txt")
...
def test_hot_dice():
    ...
    """
    diffs = diff(play, path="tests/version03/hot_dice.sim.txt")
    assert not diffs, diffs
...
def test_cheat_and_fix():
    ...
    diffs = diff(play, path="tests/version03/cheat_and_fix.sim.txt")
    assert not diffs, diffs
...
def test_zilcher():
    ...
    diffs = diff(play, path="tests/version03/zilcher.sim.txt")
    assert not diffs, diffs
